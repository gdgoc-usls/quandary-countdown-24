...
const QuandaryIcon: React.FC = () => {
    ...
    return (
        <>
            <a href={ isVisible ? "#" : "https://gdsc.omsimos.com/"} target={ isVisible ? "_self" : "_blank" } className="absolute md:top-22 xs:top-17 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center no-underline">
