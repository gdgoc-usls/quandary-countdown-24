...
const QuandaryIcon: React.FC = () => {
    ...
    return (
        <>
            <a href={ isVisible ? "https://quandary-eta.vercel.app/" : "https://gdsc.omsimos.com/"} target={ isVisible ? "_self" : "_blank" } className="absolute md:top-20 xs:top-17 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center no-underline">
                <img src={ QuandaryLogo } alt="Quandary Logo" className="duration-500 ease-in-out scale-90 xs:scale-80"/>
